...
srec_cat %cpu11_tmp%\%1.bin -binary --fill 0x00 0x0000 0x8000 -byte-swap 2 -o .\out\test.mem --VMem 16
...
copy .\out\test.mif ..\..\xen\tst\vm3.mif >> NUL
copy .\out\test.mem ..\..\xen\tst\vm3.mem >> NUL
