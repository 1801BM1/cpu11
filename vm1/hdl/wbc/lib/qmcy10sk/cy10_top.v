...
//
// Top module for QMTech Cyclone 10LP board based system
...
assign      vm_irq[2] = i50Hz; // & cy10_sw[0];  FIXME
...
//
//assign cy10_lcd_rs    = wb_stb & wb_cyc & ((wb_adr == 16'o177676) | (wb_adr == 16'o177674));
//assign cy10_lcd_data  = wb_out[7:0];
//assign cy10_lcd_en    = (wb_adr == 16'o177566) & wb_stb & wb_we & wb_ack;
...
always @(posedge wb_clk)
begin
   sys_clk_slow <= 1'b0; // cy10_sw[8]; FIXME
   sys_clk_ena  <= ena_us;
end
