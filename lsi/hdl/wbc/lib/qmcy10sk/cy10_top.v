...
//
// Top module for Cyclone 10 StarterKit board based system - LSi11 cpu
...
(
   ...
   .tx_dat_o(c10sk_uart_txd),
//   .tx_cts_i(c10sk_uart_rts),
   .rx_dat_i(c10sk_uart_rxd),
//   .rx_dtr_o(c10sk_uart_cts),
...
// FIXME
assign vm_in14[3:0]     = 4'b0000; // de2_button;
assign vm_in14[15:4]    = 12'o0000; // de2_sw[11:0];
