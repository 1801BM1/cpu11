...
vlog -vlog01compat -work work +incdir+../../tbe {../../rtl/dc_pla.v}
vlog -vlog01compat -work work +incdir+../../tbe {../../rtl/dc_pla_0.v}
vlog -vlog01compat -work work +incdir+../../tbe {../../rtl/dc_pla_1.v}
vlog -vlog01compat -work work +incdir+../../tbe {../../rtl/dc_pla_2.v}
