...
#
# qa7-vm3.tcl: Tcl script for re-creating project 'qa7-vm3'
#
...
#
# 1. This project restoration tcl script (qa7-vm3.tcl) that was generated.
#
# 2. The following source(s) files that were local or imported into the original project.
#    (Please see the '$orig_proj_dir' and '$origin_dir' variable setting below at the start of the script)
#
#    "/opt/xilinx/workspace/cpu11/xen/qa7/syn/ip/dp_ram32w/dp_ram32w.xci"
...
#    "/opt/xilinx/workspace/cpu11/xen/lib/wbc_vm3.v"
...
#    "/opt/xilinx/workspace/cpu11/vm3/hdl/wbc/rtl/vm3_plm.v"
#    "/opt/xilinx/workspace/cpu11/vm3/hdl/wbc/rtl/vm3_mmu.v
#    "/opt/xilinx/workspace/cpu11/vm3/hdl/wbc/rtl/vm3_wb.v"
#    "/opt/xilinx/workspace/cpu11/xen/tst/vm3.mem"
#
#*****************************************************************************************
...
set files [list \
 ...
 [file normalize "${origin_dir}/../../vm3/hdl/wbc/rtl/vm3_plm.v"] \
 [file normalize "${origin_dir}/../../vm3/hdl/wbc/rtl/vm3_wb.v"] \
 [file normalize "${origin_dir}/../../vm3/hdl/wbc/rtl/vm3_mmu.v"] \
 [file normalize "${origin_dir}/../lib/wbc_vm3.v"] \
 [file normalize "${origin_dir}/../tst/vm3.mem"] \
]
add_files -norecurse -fileset $obj $files

set file "$origin_dir/../tst/vm3.mem"
...
#set files [list \
# [file normalize "${origin_dir}/syn/ip/dp_ram32w/dp_ram32w.xci" ]\
#]
...
# # Set 'sources_1' fileset file properties for local files
# set file "dp_ram32w/dp_ram32w.xci"
# set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
if {[string equal [get_runs -quiet impl_3] ""]} {
    create_run -name impl_3 -part xc7a35tftg256-1 -flow {Vivado Implementation 2018} -strategy "Performance_ExplorePostRoutePhysOpt" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_2
} else {
  set_property strategy "Performance_ExplorePostRoutePhysOpt" [get_runs impl_3]
  set_property flow "Performance_ExplorePostRoutePhysOpt" [get_runs impl_3]
}
