...
#
# qa7-vm2.tcl: Tcl script for re-creating project 'qa7-vm2'
#
...
#
# 1. This project restoration tcl script (qa7-vm2.tcl) that was generated.
#
...
#    "/opt/xilinx/workspace/cpu11/vm2/hdl/wbc/rtl/vm2_plm.v"
#    "/opt/xilinx/workspace/cpu11/vm2/hdl/wbc/rtl/vm2_wb.v"
#    "/opt/xilinx/workspace/cpu11/xen/lib/wbc_vm2.v"
#    "/opt/xilinx/workspace/cpu11/xen/tst/vm2.mem"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/rtl/vm2_defs.v"] \
 ...
 [file normalize "${origin_dir}/../../vm2/hdl/wbc/rtl/vm2_plm.v"] \
 [file normalize "${origin_dir}/../../vm2/hdl/wbc/rtl/vm2_wb.v"] \
 [file normalize "${origin_dir}/../lib/wbc_vm2.v"] \
 [file normalize "${origin_dir}/../tst/vm2.mem"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/rtl/vm2_defs.v"
...
set file "$origin_dir/../tst/vm2.mem"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
...
# set_property -name "verilog_define" -value  "CONFIG_WBC_CPU=wbc_vm2"  -objects $obj
...
# # Add/Import constrs file and set constrs file properties
# set file "[file normalize "$origin_dir/syn/${board}.srcs/constrs_1/new/${board}_dbg.xdc"]"
# set file_imported [import_files -fileset constrs_1 [list $file]]
# set file "new/${board}_dbg.xdc"
# set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
# set_property -name "file_type" -value "XDC" -objects $file_obj
# 
# # Set 'constrs_1' fileset properties
# set obj [get_filesets constrs_1]
# set_property -name "target_constrs_file" -value "[get_files *new/${board}_dbg.xdc]" -objects $obj
# set_property -name "target_part" -value "${part}" -objects $obj
# set_property -name "target_ucf" -value "[get_files *new/${board}_dbg.xdc]" -objects $obj
