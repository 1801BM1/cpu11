...
create_generated_clock -name {corepll|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} -source [get_pins {corepll|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|refclkin}] -duty_cycle 50/1 -multiply_by 40 -divide_by 6 -master_clock {qc5_clock_50} [get_pins {corepll|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]}] 
create_generated_clock -name {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk} -source [get_pins {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|vco0ph[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 5 -master_clock {corepll|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} [get_pins {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] 
create_generated_clock -name {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk} -source [get_pins {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|vco0ph[0]}] -duty_cycle 50/1 -multiply_by 1 -divide_by 5 -phase 180/1 -master_clock {corepll|altera_pll_i|general[0].gpll~FRACTIONAL_PLL|vcoph[0]} [get_pins {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] 
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[1].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -fall_from [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}] -setup 0.130  
...
set_clock_uncertainty -rise_from [get_clocks {qc5_clock_50}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.130  
set_clock_uncertainty -rise_from [get_clocks {qc5_clock_50}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.130  
...
set_clock_uncertainty -fall_from [get_clocks {qc5_clock_50}] -rise_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.130  
set_clock_uncertainty -fall_from [get_clocks {qc5_clock_50}] -fall_to [get_clocks {corepll|altera_pll_i|general[0].gpll~PLL_OUTPUT_COUNTER|divclk}]  0.130  
