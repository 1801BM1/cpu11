...
//
// F-11 base Wishbone SoC, universal wrapper for all boards
...
wire [21:0] wb_adr;                    // master address out bus
...
(
   ...
   .wbi_una_o(vm_una)                  // unaddressed fast read request
);
